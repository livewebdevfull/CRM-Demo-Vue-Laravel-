...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/clients/ClientEdit.vue?vue&type=script&lang=js&":
/*!****************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/src/views/clients/ClientEdit.vue?vue&type=script&lang=js& ***!
  \****************************************************************************************************************************************************************************/
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 5:
              ...
              _context.next = 10;
              return _axios_js__WEBPACK_IMPORTED_MODULE_3__["default"].get("/api/client-list/client/" + this.$route.query.id).then(function (response) {
                if (response.data) {
    ...
    validateStep3: function validateStep3() {
      ...
      return new Promise(function (resolve, reject) {
        _this5.$validator.validateAll("step-3").then(function (result) {
          if (result) {
            if (_this5.$store.state.AppActiveUser.userRole === 'vendor') {
              var data = new FormData();
              if (_this5.file) data.append('file', _this5.file);else data.append('avatar', _this5.userImg);
              data.apeend('user_id', _this5.userId);
              data.append('first_name', _this5.firstName);
              data.append('last_name', _this5.lastName);
              data.append('gender', _this5.gender);
              data.append('email', _this5.email);
              data.append('doc_type', _this5.docType);
              data.append('doc_num', _this5.docNumber);
              data.append('birth_date', _this5.birthDate);
              data.append('cuil_first', _this5.cuilFirst);
              data.append('cuil_second', _this5.cuilSecond);
              data.append('civil_state', _this5.civilState);
              data.append('address_street', _this5.addressStreet);
              data.append('address_number', _this5.addressNumber);
              data.append('address_neighbour', _this5.addressNeighbour);
              data.append('address_location', _this5.addressLocation);
              data.append('address_cp', _this5.addressCp);
              data.append('address_province', _this5.addressProvince);
              data.append('phone_number1', _this5.phoneNumber1);
              data.append('phone_number2', _this5.phoneNumber2);
              data.append('phone_number3', _this5.phoneNumber3);
              data.append('membership_branch', _this5.membershipBranch);
              data.append('membership_class', _this5.membershipClass);
              data.append('membership_fee', _this5.membershipFee);
              data.append('employ_info', JSON.stringify(_this5.employInfo));
              data.append('bank_info', JSON.stringify(_this5.bankInfo));
              _axios_js__WEBPACK_IMPORTED_MODULE_3__["default"].post("/api/client-list/client/update/" + _this5.$route.query.id, data, {
                headers: {
      ...
      return new Promise(function (resolve, reject) {
        _this7.$validator.validateAll("step-5").then(function (result) {
          if (result) {
            ...
            _axios_js__WEBPACK_IMPORTED_MODULE_3__["default"].post("/api/client-list/client/update/" + _this7.$route.query.id, data, {
              headers: {
                'Content-Type': 'multipart/form-data'
              }
            }).then(function (response) {
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/clients/ClientEdit.vue?vue&type=template&id=25d654f4&":
/*!********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/src/views/clients/ClientEdit.vue?vue&type=template&id=25d654f4& ***!
  \********************************************************************************************************************************************************************************************************************/
...
var render = function() {
  ...
  return _c("vx-card", { attrs: { title: "Formulario de modificación" } }, [
    _c(
      "div",
      { staticClass: "mt-0" },
      [
                      ...
                      _c("div", { staticClass: "vx-row" }, [
                        ...
                        _c(
                          ...
                          [
                            ...
                            _c("span", { staticClass: "text-danger" }, [
                              _vm._v(
                                _vm._s(_vm.errors.first("step-1.doc_number"))
                              )
                            ])
                          ],
                          1
                        ...
                        _c(
                          ...
                          [
                            ...
                            _c("span", { staticClass: "text-danger" }, [
                              _vm._v(
                                _vm._s(_vm.errors.first("step-1.cuil_first"))
                              )
                            ])
                          ],
                          1
                        ...
                        _c(
                          ...
                          [
                            ...
                            _c("span", { staticClass: "text-danger" }, [
                              _vm._v(
                                _vm._s(_vm.errors.first("step-1.cuil_second"))
                              )
                            ])
                          ],
                          1
                  ...
                  _c("div", { staticClass: "vx-row" }, [
                    ...
                    _c(
                      ...
                      [
                        _c("vs-input", {
                          staticClass: "w-full",
                          attrs: { label: "Telefono3", name: "phone_number3" },
                          model: {
                        ...
                        _c("div", { staticClass: "vx-row" }, [
                          _c(
                            ...
                            [
                              _c("span", { staticClass: "text-danger" }, [
                                _vm._v(
                                  _vm._s(_vm.errors.first("step-4.bank_name"))
                                )
                              ])
                            ]
                          ),
...
/***/ "./resources/js/src/views/clients/ClientEdit.vue":
/*!*******************************************************!*\
  !*** ./resources/js/src/views/clients/ClientEdit.vue ***!
  \*******************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ClientEdit_vue_vue_type_template_id_25d654f4___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ClientEdit.vue?vue&type=template&id=25d654f4& */ "./resources/js/src/views/clients/ClientEdit.vue?vue&type=template&id=25d654f4&");
/* harmony import */ var _ClientEdit_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ClientEdit.vue?vue&type=script&lang=js& */ "./resources/js/src/views/clients/ClientEdit.vue?vue&type=script&lang=js&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _ClientEdit_vue_vue_type_template_id_25d654f4___WEBPACK_IMPORTED_MODULE_0__["render"],
  _ClientEdit_vue_vue_type_template_id_25d654f4___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/src/views/clients/ClientEdit.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/src/views/clients/ClientEdit.vue?vue&type=script&lang=js&":
/*!********************************************************************************!*\
  !*** ./resources/js/src/views/clients/ClientEdit.vue?vue&type=script&lang=js& ***!
  \********************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ClientEdit_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib??ref--4-0!../../../../../node_modules/vue-loader/lib??vue-loader-options!./ClientEdit.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/clients/ClientEdit.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ClientEdit_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/src/views/clients/ClientEdit.vue?vue&type=template&id=25d654f4&":
/*!**************************************************************************************!*\
  !*** ./resources/js/src/views/clients/ClientEdit.vue?vue&type=template&id=25d654f4& ***!
  \**************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ClientEdit_vue_vue_type_template_id_25d654f4___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib??vue-loader-options!./ClientEdit.vue?vue&type=template&id=25d654f4& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/clients/ClientEdit.vue?vue&type=template&id=25d654f4&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ClientEdit_vue_vue_type_template_id_25d654f4___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ClientEdit_vue_vue_type_template_id_25d654f4___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
