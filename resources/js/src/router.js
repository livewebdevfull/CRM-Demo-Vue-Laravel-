...
const router = new Router({
    ...
    // =============================================================================
        ...
        // =============================================================================
                ...
                {
                    path: '/users/thumb-view',
                    name: 'user-list-thumb-view',
                    component: () => import('@/views/users/thumb-view/UserListThumb.vue'),
                    meta: {
                        breadcrumb: [
                            { title: 'Inicio', url: '/' },
                            { title: 'Gestion de usuarios', active: true },
                        ],
                ...
                {
                    path: '/quota',
                    name: 'client-quota-view',
                    component: () => import('@/views/clients/ClientQuota.vue'),
                    meta: {
                        breadcrumb: [
                            { title: 'Inicio', url: '/' },
                            { title: 'Quota management', active: true },
                        ],
...

                {
                    ...
                    meta: {
                        breadcrumb: [
                            { title: 'Inicio', url: '/' },
                            { title: 'Lista de afiliados', active: true },
                        ],
                        pageTitle: 'Lista de afiliados',
                        rule: 'allow_all'
                    },
                },

                {
                    ...
                    meta: {
                        breadcrumb: [
                            { title: 'Inicio', url: '/' },
                            { title: 'Lista de afiliados', url: '/clients' },
                            { title: 'Nuevo afiliado', active: true },
                        ],
                ...
                {
                    path: '/offering',
                    name: 'offering-list-view',
                    component: () => import('@/views/offering/OfferingList.vue'),
                    meta: {
                        breadcrumb: [
                            { title: 'Inicio', url: '/' },
                            { title: 'Lista de offering', active: true },
                        ],
                        pageTitle: 'Lista de offering',
                        rule: 'allow_all'
                    },
                },

                {
                    path: '/offering/add',
                    name: 'offering-add',
                    component: () => import('@/views/offering/OfferingAdd.vue'),
                    meta: {
                        breadcrumb: [
                            { title: 'Inicio', url: '/' },
                            { title: 'Lista de afiliados', url: '/offering' },
                            { title: 'Nuevo offering', active: true },
                        ],
                        pageTitle: 'Nuevo offering',
                        rule: 'sales_manager'
                    },
                },

                {
                    path: '/offering/view',
                    name: 'offering-view',
                    component: () => import('@/views/offering/OfferingView.vue'),
                    meta: {
                        breadcrumb: [
                            { title: 'Inicio', url: '/' },
                            { title: 'Lista de afiliados', url: '/offering' },
                            { title: 'Ver Offering', active: true },
                        ],
                        pageTitle: 'Ver Offering',
                        rule: 'sales_manager'
                    },
...

                {
                    path: '/offering/edit',
                    name: 'offering-edit',
                    component: () => import('@/views/offering/OfferingEdit.vue'),
                    meta: {
                        breadcrumb: [
                            { title: 'Inicio', url: '/' },
                            { title: 'Lista de afiliados', url: '/offering' },
                            { title: 'Editar Offering', active: true },
                        ],
                        pageTitle: 'Editar Offering',
                        rule: 'allow_all'
                    },
                },
                ...
                {
                    path: '/sales',
                    name: 'sales-list-view',
                    component: () => import('@/views/sales/SalesList.vue'),
                    meta: {
                        breadcrumb: [
                            { title: 'Inicio', url: '/' },
                            { title: 'Lista de sales', active: true },
                        ],
                        pageTitle: 'Lista de sales',
                        rule: 'allow_all'
                    },
                },

                {
                    ...
                    meta: {
                        breadcrumb: [
                            { title: 'Inicio', url: '/' },
                            { title: 'Lista de afiliados', url: '/sales' },
                            { title: 'Nuevo sales', active: true },
                        ],
                        pageTitle: 'Nuevo sales',
                        rule: 'allow_all'
                    },
                },
